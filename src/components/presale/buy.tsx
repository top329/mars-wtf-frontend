        ...
        <div className="bg-[url('/img/swap-back.png')] rounded-2xl bg-cover bg-[100%_100%]">
          ...
          <div className="px-4 py-6 sm:px-6 sm:py-8 flex flex-col gap-10">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-1 sm:gap-3 items-center">
                <Image
                  ...
                  height={0}
                  sizes="100vw"
                  className="sm:w-[70px] w-[55px] object-contain hover:opacity-60 cursor-pointer"
                  onClick={addUSDC}
                />
                <div className="flex flex-col justify-center item-center">
                  <div className="flex items-center gap-2">
                    <input
                      placeholder="0.0"
                      className="bg-transparent w-[150px] text-xl sm:text-2xl outline-none border-none"
                      value={fromAmount}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-1 sm:gap-3 items-center hover:opacity-60" >
                <Image
                  src={"/img/wtf.png"}
                  width={0}
                  alt=""
                  height={0}
                  sizes="100vw"
                  className="sm:w-[70px] w-[55px] object-contain cursor-pointer"
                />
                <div className="flex flex-col justify-center item-center">
                <div className="flex items-center gap-2">
                    <input
