 ...
 */
  ...
  const _renderTokenSelector = () => (
    <div className="absolute top-[100%] left-0 bg-[#0C70A1] sm:w-[150px] w-[120px] rounded-xl px-3 py-2 flex flex-col gap-2 z-50">
      <div onClick={() => onPayTokenChange("eth")} className="flex gap-2 items-center hover:opacity-60 cursor-pointer">
        <Image
          src={"/img/eth.png"}
          width={0}
          alt=""
          height={0}
          sizes="100vw"
          className="sm:w-[50px] w-[40px] object-contain"
        />
        <span>ETH</span>
      </div>
      <div onClick={() => onPayTokenChange("usdc")} className="flex gap-2 items-center hover:opacity-60 cursor-pointer">
        <Image
          src={"/img/usdc.svg"}
          width={0}
          alt=""
  ...
  return (
    ...
    >
      <div
        className="flex flex-col justify-start max-w-[550px] bg-gradient-to-t via-[#037DA9] via-[30%] from-[#06063A] to-[#00D7FD] text-white w-full rounded-3xl"
      ...
      >
        <div className="bg-[url('/img/swap-back.png')] rounded-2xl bg-cover bg-[100%_100%]">
          ...
          >
            <h2 className="text-center text-2xl md:text-4xl">BUY <Sparkles><span className="text-[#E44C0E]">MARS-WTF</span></Sparkles></h2>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-1 sm:gap-3 items-center">
                <div className="flex gap-1 flex-none items-center relative">
                  ...
                  <Icon onClick={() => setShowTokenSelector(prev => !prev)} icon="iconamoon:arrow-up-2-bold" vFlip={!showTokenSelector} className="sm:text-4xl text-2xl cursor-pointer hover:opacity-60" />
                  {showTokenSelector && _renderTokenSelector()}
                </div>
            ...
            <button onClick={handleClick} className="wallet-button w-full flex justify-center items-center rounded-xl p-5 sm:text-2xl gap-2">
              {
                !isConnected ?
                  ...
                  isLoading ?
                    <>
                      <svg xmlns="http://www.w3.org/2000/svg" className="md:w-[40px] md:h-[40px] w-[30px] h-[30px] animate-spin" viewBox="0 0 16 16"><path fill="#ffffff" d="M8 0A8 8 0 0 0 .002 7.812C.094 4.033 2.968 1 6.5 1C10.09 1 13 4.134 13 8a1.5 1.5 0 0 0 3 0a8 8 0 0 0-8-8m0 16a8 8 0 0 0 7.998-7.812C15.906 11.967 13.032 15 9.5 15C5.91 15 3 11.866 3 8a1.5 1.5 0 0 0-3 0a8 8 0 0 0 8 8" /></svg>
                      <p className="pt-1">PROCESSING...</p>
                    </> :
                    <>
